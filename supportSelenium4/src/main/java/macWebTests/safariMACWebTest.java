...
public class safariMACWebTest {

//****** These are the strings that control the browser details ******
//****** We need to set the platformVersion to one that we currently support ******
//****** Check the cloud to see what platformVersions are available ******
//****** Ex: (macOS Monterey), (macOS Sequoia), (macOS Ventura), ******
//****** Ex: (macOS Sonoma), (macOS Big Sur) ****** 

//****** We need to set the browserVersion to one we currently support ******
//****** Check the cloud to see what browserVersions are available ******
...
//****** These are North America, Germany and Australia respectively ******
	...
	private static String browserVersion = "15";
	...
	public static void main(String[] args) throws MalformedURLException, IOException {
		...
		perfectoOptions.put("platformVersion", platformVersion);
		...
		perfectoOptions.put("scriptName", "support-MACOS-Safari");
...
// Define execution timeouts and Desktop VM Window Size
		...
		try {
			...
			reportiumClient.testStart(scriptname, new TestContext("desktopWeb", "support", "safari"));
